...
if [ -f "models/diffusion_models/qwen_image_edit_fp8_e4m3fn.safetensors" ]; then
    ...
    wget -c -P models/diffusion_models \
        https://huggingface.co/Comfy-Org/Qwen-Image-Edit_diffusion_models/resolve/main/qwen_image_edit_fp8_e4m3fn.safetensors
...
if [ -f "models/text_encoders/qwen_2.5_vl_7b_fp8_scaled.safetensors" ]; then
    ...
    wget -c -P models/text_encoders \
        https://huggingface.co/Comfy-Org/Qwen2.5-VL_text_encoders/resolve/main/qwen_2.5_vl_7b_fp8_scaled.safetensors
    echo -e "${GREEN}✓ Downloaded${NC}"
fi
...
if [ -f "models/vae/qwen_image_vae.safetensors" ]; then
    ...
    wget -c -P models/vae \
        https://huggingface.co/Comfy-Org/Qwen-Image_vae/resolve/main/qwen_image_vae.safetensors
    echo -e "${GREEN}✓ Downloaded${NC}"
fi
...
if [ -f "models/loras/Qwen-Image-Lightning-4steps-V1.0.safetensors" ]; then
    ...
    wget -c -P models/loras \
        https://huggingface.co/Comfy-Org/Qwen-Image_loras/resolve/main/Qwen-Image-Lightning-4steps-V1.0.safetensors
    echo -e "${GREEN}✓ Downloaded${NC}"
fi
